...
set Dev16_A="C:\Program Files\Microsoft Visual Studio\22022\Community\VC\Auxiliary\Build\vcvarsall.bat"
set Dev17_A="C:\Program Files\Microsoft Visual Studio\182\Community\VC\Auxiliary\Build\vcvarsall.bat"
